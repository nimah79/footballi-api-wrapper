...
class Footballi {
    ...
    public static function searchMatches($filters, $sort = 'DESC') {
        return self::curlRequest('http://api.footballiapp.ir/football/index.php/api/competition/?'.urldecode(http_build_query(array(
                'filter' => json_encode($filters),
                'sort' => json_encode(array(array('property' => 'SORT', 'direction' => $sort))))
        )));
    }
